...
// инициализации сетки случайными значениями
...
int main(int argc, char** argv) {
    ...
    // идет проверка, делится ли сетка на число процессов
    ...
    for (int iter = 0; iter < MAX_ITER; iter++) 
        ...
        // завершение всех операций обмена
